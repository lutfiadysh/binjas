                        ...
                        <form method="post" action="{{ route('user.update', $user) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="nip" id="nip" class="form-control form-control-alternative" placeholder="NIP" value="{{ $user->nip }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control form-control-alternative" placeholder="Nama Personel" value="{{ $user->name }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group input-group-alternative">
                                        ...
                                        <input class="form-control datepicker" placeholder="Select date" name="date_of_birth" type="text" value="{{ $user->date_of_birth }}">
                                    </div>
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="pangkat" id="pangkat" class="form-control form-control-alternative" value="{{ $user->pangkat }}" placeholder="Pangkat" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kesatuan" id="kesatuan" class="form-control form-control-alternative" placeholder="Kesatuan" value="{{ $user->kesatuan }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="gol" id="gol" class="form-control form-control-alternative" placeholder="Golongan" value="{{ $user->gol }}" required>
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control form-control-alternative" placeholder="Email Personel" value="{{ $user->email }}" required>
                            ...
                            <h6 class="heading-small text-muted mb-4 mt-5">{{ __('Ganti Password') }}</h6>
