                         ...
                         <div class="row">
                            <div class="pl-lg-4 col-md-6">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="row">
                                    <input type="text" name="name" id="input-name" class="form-control col-md-6 form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Lari') }}" value="{{ old('name') }}" required autofocus>
                                    <input type="text" name="name" id="input-name" class="form-control col-md-6 form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('Lari') }}" value="{{ old('name') }}" required autofocus>
                                    </div>
                                    @if ($errors->has('lari'))
                                ...
                                <div class="form-group{{ $errors->has('email') ? ' has-danger' : '' }}">
                                    ...
                                    <div class="row">
                                    <input type="text" name="pull up" id="input-email" class="form-control col-md-6 form-control-alternative{{ $errors->has('chinning') ? ' is-invalid' : '' }}" placeholder="{{ __('Pull Up/Chinning') }}" value="{{ old('email') }}" required>
                                    <input type="text" name="pull up" id="input-email" class="form-control col-md-6 form-control-alternative{{ $errors->has('chinning') ? ' is-invalid' : '' }}" placeholder="{{ __('Pull Up/Chinning') }}" value="{{ old('email') }}" required>
                                    </div>
                                ...
                                <div class="form-group{{ $errors->has('situp') ? ' has-danger' : '' }}">
                                 ...
                                 <div class="row">
                                    <input type="text" name="situp" id="input-password" class="form-control col-md-6 form-control-alternative{{ $errors->has('situp') ? ' is-invalid' : '' }}" placeholder="{{ __('sit up') }}" value="" required>
                                    <input type="text" name="situp" id="input-password" class="form-control col-md-6 form-control-alternative{{ $errors->has('situp') ? ' is-invalid' : '' }}" placeholder="{{ __('sit up') }}" value="" required>
                                 </div>
                                    @if ($errors->has('situp'))
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="row">
                                    <input type="text" name="situp" id="input-password" class="form-control col-md-6 form-control-alternative{{ $errors->has('situp') ? ' is-invalid' : '' }}" placeholder="{{ __('Push up') }}" value="" required>
                                    <input type="text" name="situp" id="input-password" class="form-control col-md-6 form-control-alternative{{ $errors->has('situp') ? ' is-invalid' : '' }}" placeholder="{{ __('Push up') }}" value="" required>
                                 </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                    <input type="text" name="situp" id="input-password" class="form-control col-md-6 form-control-alternative{{ $errors->has('situp') ? ' is-invalid' : '' }}" placeholder="{{ __('Shuttle run') }}" value="" required>
                                    <input type="text" name="situp" id="input-password" class="form-control col-md-6 form-control-alternative{{ $errors->has('situp') ? ' is-invalid' : '' }}" placeholder="{{ __('Shuttle run') }}" value="" required>
                                 </div>
                                </div>
                            </div>
