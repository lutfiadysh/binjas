                    ...
                    <div class="card-body">
                        <form method="post" action="{{ route('olahraga.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('user_id') ? ' has-danger' : '' }}">
                                    <div class="row">
                                    <input type="hidden" name="bidang" id="input-name" class="form-control col-md-6 form-control-alternative{{ $errors->has('user_id') ? ' is-invalid' : '' }}" placeholder="{{ __('User ID') }}"  value="olahraga" >
                                    </div>
                                    @if ($errors->has('user_id'))
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('user_id') }}</strong>
